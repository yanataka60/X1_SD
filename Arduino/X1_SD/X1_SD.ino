...
//実行アドレス取得
        ...
        snd1byte(g_adrs2);
        snd1byte(g_adrs1);
////  Serial.print(f_length2,HEX);
////  Serial.println(f_length1,HEX);
////  Serial.println(f_length,HEX);
////  Serial.print(s_adrs2,HEX);
////  Serial.println(s_adrs1,HEX);
////  Serial.println(s_adrs,HEX);
////  Serial.print(g_adrs2,HEX);
////  Serial.println(g_adrs1,HEX);
////  Serial.println(g_adrs,HEX);
//        file.seek(32);
...
//ファイルサイズ送信
      ...
      byte f_len1 = f_length / 256;
      byte f_len2 = f_length % 256;
      snd1byte(f_len2);
      snd1byte(f_len1);
////  Serial.println(f_length,HEX);
