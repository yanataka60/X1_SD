...
　S-OS SWORD起動直後に「DV S:」としてSYSTEMデバイスに切り替えておいた方が無難です。なお、SDカードアクセスルーチンはF800h～FC80hに配置されています。
...
　なお、SDカードアクセスルーチンは14A0h～192Ehに配置されています。
...
　なお、SDカードアクセスルーチンはF800h～FC8Dhに配置されています。
