...
　保存した「IOCS.bin」の後ろにバイナリエディタ等を使ってBOOTフォルダ内の「boot.bin」を付け加えます。0000h～17E7hのファイルとなるはずです。

　次にファイルの先頭に以下に示す32Byteのヘッダを付加します。0000h～1807hのファイルとなります。

　[0000] 01 58 31 5F 53 44 20 42 4F 4F 54 20 20 20 20 20

　[0010] 20 20 E8 17 00 00 00 00 20 20 20 20 20 20 00 00
