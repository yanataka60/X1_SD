...
　なお、アプリケーション中でのSD-CARDとのロード、セーブについては、アプリケーションごとにSD-CARD対応化を行う必要があり、現在対応しているのはBASIC CZ-8CB01、S-OS SWORD(Oh!MZ 1987/3)、TTLインタプリタ(Oh!MZ 1984/10)、EDAS(月刊I/O 1984/6)、X1エディタ・アセンブラ(マシン語プログラム入門)です。
